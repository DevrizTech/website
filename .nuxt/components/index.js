...
export const LazyHeading = import('../..\\components\\heading.vue' /* webpackChunkName: "components/heading" */).then(c => wrapFunctional(c.default || c))
...
export const LazyStack = import('../..\\components\\stack.vue' /* webpackChunkName: "components/stack" */).then(c => wrapFunctional(c.default || c))
